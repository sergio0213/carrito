...
public class ClienteJpaController implements Serializable {
    ...
    public Cliente findCliente(Integer id) {
       ...
       public boolean findClienteUsuario(Cliente c) {
        EntityManager em = getEntityManager();
        try {
         TypedQuery<Cliente> query    =   em.createNamedQuery("Cliente.findByUsuario", Cliente.class);
         query.setParameter("usuario", c.getUsuario());
         
         if (query.getResultList().size()>0) {
               System.err.println(" findClienteUsuario ....if  ok");
